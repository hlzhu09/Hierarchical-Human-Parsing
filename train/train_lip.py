...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='magnet_stem_grid_st1fea_gate_ob')
    # Datasets
    parser.add_argument('--root', default='./data/LIP/train_set', type=str)
    parser.add_argument('--val-root', default='./data/LIP/val_set/', type=str)
    parser.add_argument('--lst', default='./data/LIP/train_id.txt', type=str)
    parser.add_argument('--val-lst', default='./data/LIP/val_id.txt', type=str)
