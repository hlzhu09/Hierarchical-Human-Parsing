...
from dataset.datasets import LIPValGenerator
...
def get_arguments():
    ...
    parser.add_argument("--root", type=str, default='./data/LIP/val_set/')
    parser.add_argument("--data-list", type=str, default='./dataset/LIP/val_id.txt')
    parser.add_argument("--crop-size", type=int, default=473)
    parser.add_argument("--num-classes", type=int, default=20)
    parser.add_argument("--ignore-label", type=int, default=255)
    parser.add_argument("--restore-from", type=str,
                        default='./checkpoints/exp/model_best.pth')
...
def main():
    ...
    testloader = data.DataLoader(LIPValGenerator(args.root, args.data_list, crop_size=args.crop_size),
