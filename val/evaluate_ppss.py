...
from dataset.datappss import TestGenerator
...
def get_arguments():
    ...
    parser.add_argument('--root', default='./data/PPSS/TestData/', type=str)
    parser.add_argument("--data-list", type=str, default='./dataset/PPSS/test_id.txt')
...
def main():
    ...
    for index, batch in enumerate(testloader):
        ...
        # img_name = "/home/hlzhu/hlzhu/Iter_ParseNet_final/data/Person/JPEGImages/"+name[0]+'.jpg'
        # print(img_name)
